## I fixed the PCA training and testing sets, but PCA RF still doesn't work.  I also tried Naive Bayes and couldn't get it to work
## And I changed the sparseness percentage and couldn't get an accuracy above 65% (Chris, maybe set your seed
## so we can consistently get 66%?)
...
Aut_RF = randomForest(x=X_train_pca, y=as.factor(labels),ntree=100)

Aut_pred =predict(Aut_RF,newdata=X_test_pca)
